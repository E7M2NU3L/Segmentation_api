...
dataset_in = "C://Users/navin/OneDrive/Documents/Project_Work/api_development/Dataset_Converted/Image_train/*"
mask_in = "C://Users/navin/OneDrive/Documents/Project_Work/api_development/Dataset_Converted/Masks_train/*"
...
train_masks = [] 
for directory_path in glob.glob(mask_in):
...
img_test = "C://Users/navin/OneDrive/Documents/Project_Work/api_development/Dataset_Converted/test/image/patient_00318.jpg"
img_mask = "C://Users/navin/OneDrive/Documents/Project_Work/api_development/Dataset_Converted//test/mask/patient_03186.jpg"

########################
#Load validation image and prepare it for prediction
validation_img = cv2.imread(img_test, cv2.IMREAD_COLOR)       
...
truth = cv2.imread(img_mask, 0).reshape(-1)
####################################################################################
...
import joblib
joblib.dump(xgb_model, 'segmenter_xgb.joblib')
...
joblib.dump(lgb_model,'segmenter_lgb.joblib')
